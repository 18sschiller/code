...
public class Snake extends JFrame implements Runnable {
	...
	int score, direction, prevDirection;
	final int UP =		0; final int DOWN =	1;
	final int LEFT =	2; final int RIGHT =	3;
	int pieceSize = 10; int speed = 3;
	int fieldWidth = 30; int fieldHeight = 30;
